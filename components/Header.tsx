    ...
    <header className="bg-gray-900">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1 justify-center">
          ...
          <h1 className="text-primary text-2xl font-semibold justify-center px-3 my-auto">Robbie Williams</h1>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link
            ...
            // TODO open modal.
            // onClick={async () => login()}
            className="text-sm bg-primary text-background p-3 rounded-xl font-semibold leading-6"
          >
      ...
      <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="-m-2.5 rounded-md bg-primary p-2.5 text-gray-400" onClick={() => setMobileMenuOpen(false)}>
